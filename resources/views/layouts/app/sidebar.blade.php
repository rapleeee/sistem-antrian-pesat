            ...
            <flux:sidebar.nav>
                @if(auth()->user()?->isSuperAdmin())
                    <flux:sidebar.group :heading="__('Admin')" class="grid">
                        ...
                        <flux:sidebar.item icon="layout-grid" :href="route('admin.panels')" :current="request()->routeIs('admin.panels') || request()->routeIs('admin.participants')" wire:navigate>
                            Panel
                        </flux:sidebar.item>
                ...
                <flux:sidebar.group :heading="__('Publik')" class="grid">
                    <flux:sidebar.item icon="tv" :href="route('display.all')" target="_blank">
                        Display Board
                    </flux:sidebar.item>
                </flux:sidebar.group>
            </flux:sidebar.nav>
